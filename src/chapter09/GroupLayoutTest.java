...
/**
 * A frame that users a group layout to arrange font selection components.
 */
class FontFrame extends JFrame {
	...
	public FontFrame() {
		...
		face = new JComboBox<Object>(new String[] {"Serif", "SanSerif", "Monospaced", "Dialog", "DialogInput" });
		face.addActionListener(listener);
		JLabel sizeLabel = new JLabel("Size: ");
		size = new JComboBox<Object>(new String[] {"8", "10", "12", "15", "18", "36", "48"});
